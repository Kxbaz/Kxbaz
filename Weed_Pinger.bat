title IP Pinger V4 - Made by teryfied 
echo off
cls
...
echo                       000000000
echo                     000     000000
echo   Insta-teryfied.kys
echo.                                                                                         
set /p IP=[40;37mWhich IP We Blazing Today teryfied
:v6
echo [47;30m
PING -n 1 %IP% | FIND "TTL="
IF ERRORLEVEL 1 (echo [41;37m-------------------------- %IP% FAILED TO OUTSMOKE LILBRAT --------------------[40;37m)
...
echo [46;37m
PING -n 1 %IP% | FIND "TTL="
IF ERRORLEVEL 1 (echo [41;37m-------------------------- %IP% IS TO HIGH --------------------[40;37m)
ping localhost -n 1 >nul
ping localhost -n 1 >nul
ping localhost -n 1 >nul
ping localhost -n 1 >nul
